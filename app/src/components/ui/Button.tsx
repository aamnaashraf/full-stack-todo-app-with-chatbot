...
export default function Button({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-gray-200 hover:bg-gray-300 text-gray-800 border-transparent focus:ring-gray-500 dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white',
    danger: 'bg-red-600 hover:bg-red-700 text-white border-transparent focus:ring-red-500',
    ghost: 'bg-transparent hover:bg-gray-100 text-gray-700 border-transparent focus:ring-gray-500 dark:text-gray-300 dark:hover:bg-gray-700'
  }
